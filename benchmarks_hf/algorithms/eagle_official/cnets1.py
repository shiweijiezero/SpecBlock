...
class Model(nn.Module):
    ...
    def topK_genrate(self, hidden_states, input_ids, head, logits_processor):
        ...
        # Per-depth forward timing
        self._depth_forward_events = []
        ...
        blk_end.record()
        self._depth_forward_events.append((0, blk_start, blk_end))
        ...
        for i in range(depth):
            ...
            blk_end.record()
            self._depth_forward_events.append((i + 1, blk_start, blk_end))
