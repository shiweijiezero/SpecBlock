...
class ServerArgs:
    ...
    def _handle_speculative_decoding(self):
        ...
        if self.speculative_algorithm in ("EAGLE", "EAGLE3", "STANDALONE", "SPECBLOCK_SHIFT"):
            ...
            if (
                self.speculative_algorithm in ["EAGLE", "EAGLE3", "STANDALONE", "SPECBLOCK_SHIFT"]
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            choices=["EAGLE", "EAGLE3", "NEXTN", "STANDALONE", "NGRAM", "SPECBLOCK_SHIFT"],
