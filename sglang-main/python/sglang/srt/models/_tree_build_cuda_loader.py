...
Wraps the C++/CUDA kernels in _tree_build_cuda.cu via torch.utils.cpp_extension.load.
...
def _get_module():
    ...
    with _MOD_LOCK:
        ...
        cu_src = os.path.join(src_dir, '_tree_build_cuda.cu')
        _MOD = _load(
            name='_specblock_tree_build_cuda',
            sources=[cu_src],
